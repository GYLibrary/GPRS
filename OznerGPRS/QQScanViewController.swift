...
import UIKit
import swiftScan
typealias ScanBlock = (String?) -> Void

class QQScanViewController: LBXScanViewController ,UIAlertViewDelegate{
...
// MARK: - 底部几个功能：开启闪光灯、相册、我的二维码
    ...
    override func handleCodeResult(arrayResult: [LBXScanResult]) {
        ...
        if !(result.strScanned?.contains("deviceType"))! || !(result.strScanned?.contains("deviceId"))!{
        ...
        let alertView = UIAlertView(title: "发现设备", message: result.strScanned!, delegate: self, cancelButtonTitle: "取消", otherButtonTitles: "确定")
...
//        navigationController?.pushViewController(vc, animated: true)
    ...
    func alertView(_ alertView: UIAlertView, clickedButtonAt buttonIndex: Int) {
        ...
        let arr = result.strScanned?.components(separatedBy: "deviceType=")
